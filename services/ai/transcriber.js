...
const getAIClient = async (companyId) => {
    let apiKey = process.env.NEXT_PUBLIC_GEMINI_API_KEY || process.env.API_KEY || process.env.GEMINI_API_KEY; // Fallback Global
...
/**
 * Transcreve um buffer de áudio usando Gemini 3 Flash
